...
DROP INDEX IF EXISTS idx_produk_tenant_kode;
DROP INDEX IF EXISTS idx_produk_tenant_stok;
DROP INDEX IF EXISTS idx_penjualan_tenant_created;
DROP INDEX IF EXISTS idx_stok_log_tenant_created;
DROP INDEX IF EXISTS idx_detail_penjualan_tenant;
