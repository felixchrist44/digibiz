      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 rounded-3xl p-8 shadow-2xl">
          ...
          <form action={formAction} className="space-y-6">
            ...
            {/* Nama Toko Input (Only on Sign Up Mode and NOT staff invite) */}
            {isSignUp && !inviteToken && (
              <div className="animate-in fade-in duration-200">
                <label htmlFor="namaToko" className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">
                  Nama Toko / Bisnis
                </label>
                <div className="relative rounded-xl shadow-sm">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
